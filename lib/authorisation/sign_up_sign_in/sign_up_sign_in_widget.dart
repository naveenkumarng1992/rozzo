...
import 'sign_up_sign_in_model.dart';
export 'sign_up_sign_in_model.dart';
...
class _SignUpSignInWidgetState extends State<SignUpSignInWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SignUpSignIn'});
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'SIGN_UP_SIGN_IN_PAGE_SIGN_IN_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_auth');
                                                      GoRouter.of(context)
                                                          .prepareAuthEvent();
                                                      ...
                                                      _model.querytoupdatedeviceidinsupabase =
                                                          await PushNotificationFcmTokensTable()
                                                              .queryRows(
                                                        queryFn: (q) => q
                                                            .eqOrNull(
                                                              'user_id',
                                                      ...
                                                      if ((_model.querytoupdatedeviceidinsupabase !=
                                                                  null &&
                                                              (_model.querytoupdatedeviceidinsupabase)!
                                                                  .isNotEmpty) !=
                                                          true) {
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'SIGN_UP_SIGN_IN_CREATE_ACCOUNT_BTN_ON_TA');
                                                      logFirebaseEvent(
                                                          'Button_auth');
                                                      GoRouter.of(context)
                                                          .prepareAuthEvent();
