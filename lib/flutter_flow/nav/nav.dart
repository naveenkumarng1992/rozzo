...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AIChatPage')
              : AIChatPageWidget(),
        ),
        FFRoute(
          name: QuestionPageClinicalcasesWidget.routeName,
          path: QuestionPageClinicalcasesWidget.routePath,
          builder: (context, params) => QuestionPageClinicalcasesWidget(),
        ),
        FFRoute(
          name: TestpageformultiquestionsWidget.routeName,
          path: TestpageformultiquestionsWidget.routePath,
          builder: (context, params) => TestpageformultiquestionsWidget(),
        ),
        FFRoute(
          name: TestmultiselectWidget.routeName,
          path: TestmultiselectWidget.routePath,
          builder: (context, params) => TestmultiselectWidget(),
        ),
        FFRoute(
          name: DifficultyLevelWidget.routeName,
          path: DifficultyLevelWidget.routePath,
          builder: (context, params) => DifficultyLevelWidget(),
        ),
        FFRoute(
          name: ChoosAIModeWidget.routeName,
          path: ChoosAIModeWidget.routePath,
          builder: (context, params) => ChoosAIModeWidget(),
        ),
        FFRoute(
          name: AiTopicSystemNameWidget.routeName,
          path: AiTopicSystemNameWidget.routePath,
          builder: (context, params) => AiTopicSystemNameWidget(),
        )
