...
class DifficultyLevelWidget extends StatefulWidget {
  const DifficultyLevelWidget({super.key});

  static String routeName = 'DifficultyLevel';
  static String routePath = '/difficultyLevel';
...
class _DifficultyLevelWidgetState extends State<DifficultyLevelWidget>
  ...
  late DifficultyLevelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DifficultyLevelModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DifficultyLevel'});
                    ...
                    child: FutureBuilder<List<AnatomyQuestionDetailsRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<AnatomyQuestionDetailsRow>
                            containerAnatomyQuestionDetailsRowList =
                            snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                text: valueOrDefault<String>(
                                                  containerAnatomyQuestionDetailsRow
                                                      ?.topicName,
                                                  'Topic name is not available',
                                                ),
                                                style: TextStyle(
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DIFFICULTY_LEVEL_Container_rd8qdft1_ON_T');
                                      logFirebaseEvent(
                                          'Container_update_app_state');
                                      FFAppState().DifficultyLevel = 1;
                                      safeSetState(() {});
                                      ...
                                      context.pushNamed(
                                          QuestionPageClinicalcasesWidget
                                              .routeName);
                                    },
                                    child: Material(
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DIFFICULTY_LEVEL_Container_3ugg4ts8_ON_T');
                                      logFirebaseEvent(
                                          'Container_update_app_state');
                                      FFAppState().DifficultyLevel = 2;
                                      safeSetState(() {});
                                      logFirebaseEvent('Container_wait__delay');
                                      await Future.delayed(
                                        Duration(
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DIFFICULTY_LEVEL_Container_04ax77rd_ON_T');
                                      logFirebaseEvent(
                                          'Container_update_app_state');
                                      FFAppState().DifficultyLevel = 3;
                                      safeSetState(() {});
                                      logFirebaseEvent('Container_wait__delay');
                                      await Future.delayed(
                                        Duration(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Challenge me with tricky cases',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
