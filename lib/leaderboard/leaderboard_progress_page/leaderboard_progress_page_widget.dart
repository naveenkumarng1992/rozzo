...
import 'leaderboard_progress_page_model.dart';
export 'leaderboard_progress_page_model.dart';

class LeaderboardProgressPageWidget extends StatefulWidget {
  const LeaderboardProgressPageWidget({super.key});

  static String routeName = 'Leaderboard_Progress_Page';
  static String routePath = '/leaderboardProgressPage';

  @override
  State<LeaderboardProgressPageWidget> createState() =>
      _LeaderboardProgressPageWidgetState();
}

class _LeaderboardProgressPageWidgetState
    extends State<LeaderboardProgressPageWidget> with TickerProviderStateMixin {
  late LeaderboardProgressPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaderboardProgressPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Leaderboard_Progress_Page'});
                                        ...
                                        children: [
                                            ...
                                            child: FutureBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'LEADERBOARD_PROGRESS_Row_ssphfri5_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Row_bottom_sheet');
                                                        ...
                                                        return Opacity(
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child:
                                                              ...
                                                              rowLeaderboardLeagueTableRow
                                                                  .icon!,
                                                              width: stackLeaderboardUserRankInTheGroupRow
                                                                          .leagueNumber ==
                                                                      rowLeaderboardLeagueTableRow
                                                                          .leagueNumber
                                                                  ? 130.0
                                                                  : 90.0,
                                                              height: stackLeaderboardUserRankInTheGroupRow
                                                                          .leagueNumber ==
                                                                      rowLeaderboardLeagueTableRow
                                                                          .leagueNumber
                                                                  ? 130.0
                                          ...
                                          Padding(
                                            ...
                                            child: FutureBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<LeaderboardUserRankInTheGroupRow>
                                                    richTextLeaderboardUserRankInTheGroupRowList =
                                                    snapshot.data!;

                                                final richTextLeaderboardUserRankInTheGroupRow =
                                                    richTextLeaderboardUserRankInTheGroupRowList
                                                            .isNotEmpty
                                                        ? richTextLeaderboardUserRankInTheGroupRowList
                                                            .first
                                                  ...
                                                  text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text: valueOrDefault<
                                                            String>(
                                                          richTextLeaderboardUserRankInTheGroupRow
                                                              ?.rankInGroup
                                                              ?.toString(),
                                                          '1',
                                                        ),
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: Stack(
                                                          children: [
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: Image.network(
                                                                                    listViewLeaderboardUserRankInTheGroupRow.profilePicture != null && listViewLeaderboardUserRankInTheGroupRow.profilePicture != '' ? listViewLeaderboardUserRankInTheGroupRow.profilePicture! : 'https://wynwfipbypahdzczidep.supabase.co/storage/v1/object/public/profilepicture/Boys/70595a34c9c1ad3d4a6a379536184c1e.jpg',
                                                                                    fit: BoxFit.cover,
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              listViewLeaderboardUserRankInTheGroupRow.userName,
                                                                              'user name',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.poppins(
                                                            ...
                                                            if (listViewLeaderboardUserRankInTheGroupRow
                                                                    .userId ==
                                                                currentUserUid)
                                                              Lottie.asset(
                                                                'assets/jsons/Animation_-_1750331406250.json',
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'LEADERBOARD_PROGRESS_CONTINUE_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_navigate_to');
