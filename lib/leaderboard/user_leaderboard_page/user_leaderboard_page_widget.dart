...
import 'user_leaderboard_page_model.dart';
export 'user_leaderboard_page_model.dart';

class UserLeaderboardPageWidget extends StatefulWidget {
  const UserLeaderboardPageWidget({super.key});

  static String routeName = 'User_Leaderboard_Page';
  static String routePath = '/userLeaderboardPage';

  @override
  State<UserLeaderboardPageWidget> createState() =>
      _UserLeaderboardPageWidgetState();
}

class _UserLeaderboardPageWidgetState extends State<UserLeaderboardPageWidget>
    with TickerProviderStateMixin {
  late UserLeaderboardPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserLeaderboardPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'User_Leaderboard_Page'});
                                        ...
                                        children: [
                                            ...
                                            child: FutureBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'USER_LEADERBOARD_ListView_j50oyngm_ON_TA');
                                                    logFirebaseEvent(
                                                        'Row_bottom_sheet');
                                          ...
                                          FutureBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<LeaderboardUserRankInTheGroupRow>
                                                  containerLeaderboardUserRankInTheGroupRowList =
                                                  snapshot.data!;

                                              final containerLeaderboardUserRankInTheGroupRow =
                                                  containerLeaderboardUserRankInTheGroupRowList
                                                          .isNotEmpty
                                                      ? containerLeaderboardUserRankInTheGroupRowList
                                                          .first
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                if (listViewLeaderboardUserRankInTheGroupRow
                                                                        .rankInGroup ==
                                                                    (((containerLeaderboardUserRankInTheGroupRow!.rankInGroup!) *
                                                                            0.84)
                                                                        .ceil()))
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 50.0, 0.0, 0.0),
                                    child: Text(
                                      'The Leaderboard Opens on Monday... Are You Ready?',
