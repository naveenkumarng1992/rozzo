        ...
        body: SafeArea(
          ...
          child: FutureBuilder<List<UserDetailsRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<UserDetailsRow> columnUserDetailsRowList = snapshot.data!;

              final columnUserDetailsRow = columnUserDetailsRowList.isNotEmpty
                        ...
                        children: [
                          Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'USER_DETAILS_PAGE_Image_85n9jb0x_ON_TAP');
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  columnUserDetailsRow?.profilePictureUrl !=
                                              null &&
                                          columnUserDetailsRow
                                                  ?.profilePictureUrl !=
                                              ''
                                      ? columnUserDetailsRow!.profilePictureUrl!
                                      : 'https://wynwfipbypahdzczidep.supabase.co/storage/v1/object/public/profilepicture/Girls/2f77570d38faa87ee12517a66442eb6d.jpg',
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'USER_DETAILS_PAGE_Icon_r8ac9o47_ON_TAP');
                                      ...
                                      child: FutureBuilder<
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<LeaderboardUserRankInTheGroupRow>
                                              rowLeaderboardUserRankInTheGroupRowList =
                                              snapshot.data!;

                                          final rowLeaderboardUserRankInTheGroupRow =
                                              rowLeaderboardUserRankInTheGroupRowList
                                                      .isNotEmpty
                                                  ? rowLeaderboardUserRankInTheGroupRowList
                                                      .first
                                              ...
                                              Padding(
                                                ...
                                                child: FutureBuilder<
                                                  ...
                                                  future:
                                                    ...
                                                    queryFn: (q) => q.eqOrNull(
                                                      'league_id',
                                                      rowLeaderboardUserRankInTheGroupRow
                                                          ?.leagueNumber,
                                                    ),
                                                  ),
                                                  builder: (context, snapshot) {
