...
class AnatomyQuestionDetails2Table
    extends SupabaseTable<AnatomyQuestionDetails2Row> {
  @override
  String get tableName => 'anatomy_question_details_2';

  @override
  AnatomyQuestionDetails2Row createRow(Map<String, dynamic> data) =>
      AnatomyQuestionDetails2Row(data);
}

class AnatomyQuestionDetails2Row extends SupabaseDataRow {
  AnatomyQuestionDetails2Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AnatomyQuestionDetails2Table();
