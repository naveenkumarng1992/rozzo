...
class AnatomyQuestionDetails1Table
    extends SupabaseTable<AnatomyQuestionDetails1Row> {
  @override
  String get tableName => 'anatomy_question_details_1';

  @override
  AnatomyQuestionDetails1Row createRow(Map<String, dynamic> data) =>
      AnatomyQuestionDetails1Row(data);
}

class AnatomyQuestionDetails1Row extends SupabaseDataRow {
  AnatomyQuestionDetails1Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AnatomyQuestionDetails1Table();
