...
import 'change_user_state_model.dart';
export 'change_user_state_model.dart';

class ChangeUserStateWidget extends StatefulWidget {
  const ChangeUserStateWidget({
    super.key,
    int? countrychosen,
  ...
  static String routeName = 'Change_User_State';
  static String routePath = '/changeUserState';

  @override
  State<ChangeUserStateWidget> createState() => _ChangeUserStateWidgetState();
}

class _ChangeUserStateWidgetState extends State<ChangeUserStateWidget>
    with TickerProviderStateMixin {
  late ChangeUserStateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangeUserStateModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Change_User_State'});
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('CHANGE_USER_STATE_Column_oz4z1mu6_ON_TAP');
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHANGE_USER_STATE_Icon_o6di35rf_ON_TAP');
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CHANGE_USER_STATE_ULNAR_ARTERY_BTN_ON_TA');
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CHANGE_USER_STATE_CONTINUE_BTN_ON_TAP');
