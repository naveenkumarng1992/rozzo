...
import 'home_page_copynormalquery_model.dart';
export 'home_page_copynormalquery_model.dart';

class HomePageCopynormalqueryWidget extends StatefulWidget {
  const HomePageCopynormalqueryWidget({super.key});

  static String routeName = 'HomePageCopynormalquery';
  static String routePath = '/homePageCopynormalquery';

  @override
  State<HomePageCopynormalqueryWidget> createState() =>
      _HomePageCopynormalqueryWidgetState();
}

class _HomePageCopynormalqueryWidgetState
    extends State<HomePageCopynormalqueryWidget> {
  late HomePageCopynormalqueryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageCopynormalqueryModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'HomePageCopynormalquery'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('HOME_COPYNORMALQUERY_HomePageCopynormalq');
      logFirebaseEvent('HomePageCopynormalquery_backend_call');
      ...
      logFirebaseEvent('HomePageCopynormalquery_update_app_state');
      ...
      if (FFAppState().fcmToken == '') {
        logFirebaseEvent('HomePageCopynormalquery_custom_action');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserDetailsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDetailsRow> homePageCopynormalqueryUserDetailsRowList =
            snapshot.data!;

        final homePageCopynormalqueryUserDetailsRow =
            homePageCopynormalqueryUserDetailsRowList.isNotEmpty
                ? homePageCopynormalqueryUserDetailsRowList.first
                : null;
              ...
              appBar: FFAppState().currentsectionno == 0
                  ? AppBar(
                      ...
                      title: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'HOME_COPYNORMALQUERY_Text_am67g2i7_ON_TA');
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'HOME_COPYNORMALQUERY_Container_sdfz1mo2_');
                                                                  if (FFAppState()
                                                                          .noofhearts !=
                                                                      0) {
                                                                    if (containerUserProgressRow
                                                                      ...
                                                                      FFAppState()
                                                                              .currentlessonno =
                                                                          homePageCopynormalqueryUserDetailsRow!
                                                                              .currentLessonNo!;
                                                                      safeSetState(
                                                                          () {});
                                                                      logFirebaseEvent(
                                                                      ...
                                                                      if (_model.querytocheckiflesson5iscompletedforreview !=
                                                                        ...
                                                                        FFAppState().currentlessonno =
                                                                            homePageCopynormalqueryUserDetailsRow.currentLessonNo!;
                                                                        FFAppState().isreview =
                                                                            true;
                                                                        safeSetState(
                                                                            () {});
                              ...
                              child: FutureBuilder<List<SectionDetailRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_COPYNORMALQUERY_Row_vn6b620s_ON_TAP');
