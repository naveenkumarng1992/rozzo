  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: FutureBuilder<List<AnatomyLevelDetailRow>>(
          ...
          builder: (context, snapshot) {
            ...
            List<AnatomyLevelDetailRow> columnAnatomyLevelDetailRowList =
                snapshot.data!;

            final columnAnatomyLevelDetailRow =
                columnAnatomyLevelDetailRowList.isNotEmpty
                    ? columnAnatomyLevelDetailRowList.first
                    : null;
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ALLOWNOTIFICATIONS_NOT_NOW_BTN_ON_TAP');
